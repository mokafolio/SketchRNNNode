 ...
 * Edited by Matthias Dorfelt <@mokafolio github> for NodeJS
 *
 * @fileoverview Sketch-RNN Javascript Inference Library
 */

//require dependencies if we are running node
if (typeof require !== 'undefined') {
    var nj = require("numjs");
    var atob = require("atob");
}
//otherwise atob will be part of the browser by default.
//it's your responsibility to provide numjs as nj.
...
(function(global) {
    ...
    global.LSTMCell = LSTMCell;
    global.SketchRNN = SketchRNN;
